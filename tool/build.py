...
def make_image_url(image_path: Path, output_path: Path) -> str:
...
def build_items(
    ...
    for image_path in image_paths:
        ...
        test_label = "B\u00e0i t\u1ed5ng h\u1ee3p" if test == "__all__" else (
            f"Test {test_match.group(1)}" if test_match else test
        )
        ...
        items.append(
            {
                ...
                "sourceContent": translation.get("sourceContent", {}),
...
def main() -> None:
    ...
    items = build_items(data_dir, marked_dir, image_paths, output_path, translations)
